...
from config import (BASE_DIR, MODELO_FASE1, MODELO_FASE2,
...
def resumen_gasto() -> None:
    ...
    for modelo, d in sorted(GASTO.por_modelo.items()):
        ...
        ui.log(f"  {modelo}: {d['llamadas']} llamadas{nota}, "
...
def _llamada_con_hard_timeout(fn, *, hard_timeout: float, **kwargs):
